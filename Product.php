...
<head>
    ...
    #articles {margin-bottom:50px;}
     ...
     @media only screen and (width: 767px) { body{margin-top:150px;}}
        #articles .row{margin-top:20px;margin-bottom:10px;font-weight:800;}
        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" name="keyword" class="form-control" placeholder="Search for a article , Author Or Category" style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
            ...
            echo'
               <a href="'.$description.'">
                <div class="col-sm-6 col-md-3 col-lg-3 text-center">
                    <div class="article-block" style="border :3px solid #DEEAEE;">
