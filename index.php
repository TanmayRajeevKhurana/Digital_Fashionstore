...
<head>
    ...
    <title>Digital Fashionstore</title>
    <!-- Bootstrap -->
      ...
      <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
          <div>
              <form role="search" method="POST" action="Result.php">
                  <input type="text" class="form-control" name="keyword" style="width:80%;margin:20px 10% 20px 10%;" placeholder="Search for Articles">
              </form>
          </div>
      </div>
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:#D67B22;color:#fff;font-weight:800;border:none;padding:15px;"> The Fashion Shop </div>
                  <ul>
                  ...
                  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                          <div class="item active">
                            <img class="img-responsive" src="img/carousel/bw.jpg">
                          </div>

                          <div class="item">
                            <img class="img-responsive "src="img/carousel/bw2.jpg">
                          </div>
              ...
              <div class="col-md-3 col-lg-3" id="offer">
                  <a href="">              <img class="img-responsive center-block" src="img/offers/topwearoffer.png"></a>
                  <a href="">        <img class="img-responsive center-block" src="img/offers/bottomwearoffer.png"></a>
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-1&category=new">
              <div class="article-block">
                  ...
                  <img class="article block-center img-responsive" src="img/new/NEW.png">
                  <hr>
                  Yellow Tee <br>
                  Rs 113  &nbsp
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-2&category=new">
              <div class="article-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/new/jeans.png">
                  <hr>
                  Jeans  <br>
                  Rs 680 &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 1200 </span>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-3&category=new">
              <div class="article-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/new/shirt.png">
                  <hr>
                  Shirt <br>
                  Rs 400 &nbsp
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-4&category=new">
              <div class="article-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/new/polo.png">
                  <hr>
                  Polo <br>
                  Rs 289 &nbsp
              ...
              <div class="col-sm-7 col-md-5 col-lg-5">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 text-center">
                          ...
                          <p>tanmayrajivkhurana@gmail.com</p>
                      </div>
                  </div>
              </div>
