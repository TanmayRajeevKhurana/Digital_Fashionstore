...
<head>
    ...
    <style>
        ...
        #articles {border:1px solid #DEEAEE; margin-bottom:20px;padding-top:30px;padding-bottom:20px;background:#fff; margin-left:10%;margin-right:10%;}
...
echo'                           <br><br><br>
                                <a id="buyLink" href="'.$target.'" class="btn btn-lg btn-danger" style="padding:15px;color:white;text-decoration:none;">
                                    ADD TO CART for Rs 800 <br>
                                    <span style="text-decoration:line-through;"> RS920</span>
                                    | 
                                 </a>
