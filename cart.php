      ...
      <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
          <div>
              <form role="search" method="POST" action="Result.php">
                  <input type="text" class="form-control" name="keyword" style="width:80%;margin:20px 10% 20px 10%;" placeholder="Search for a Article , Designer Or Category">
              </form>
          </div>
      </div>
	...
	if(isset($_SESSION['user']))
	    {
              	if(isset($_GET['ID']))
	            {
              	...
              	$query="SELECT PID,Title,Designer,Edition,Quantity,Price FROM cart INNER JOIN products ON cart.Product=products.PID
